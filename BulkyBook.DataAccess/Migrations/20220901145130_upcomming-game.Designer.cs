...
namespace BulkyBook.DataAccess.Migrations
{
    ...
    [Migration("20220901145130_upcomming-game")]
    partial class upcomminggame
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BulkyBook.Models.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BulkyBook.Models.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BulkyBook.Models.Gallery", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BulkyBook.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BulkyBook.Models.OrderHeader", b =>
                {
                    ...
                    b.Property<double?>("Dpercent")
                        .HasColumnType("float");

                    b.Property<double>("Netamount")
                        .HasColumnType("float");

                    b.Property<double?>("Tendor")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("BulkyBook.Models.Transaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BulkyBook.Models.Upcomming", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BulkyBook.Models.Video", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BulkyBook.Models.Comment", b =>
                {
                    ...
                    b.HasOne("BulkyBook.Models.Video", "Video")
                        .WithMany()
            ...
            modelBuilder.Entity("BulkyBook.Models.OrderHeader", b =>
                {
                    ...
                    b.HasOne("BulkyBook.Models.Customer", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BulkyBook.Models.Transaction", "Transaction")
                        .WithMany()
