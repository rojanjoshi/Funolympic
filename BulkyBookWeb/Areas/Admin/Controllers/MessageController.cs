...
namespace BulkyBookWeb.Areas.Admin.Controllers
{
    ...
    public class MessageController : Controller
    {
        ...
        public MessageController(IUnitOfWork unitOfWork, IWebHostEnvironment hostEnvironment)
        {
        ...
        {
            var messageList = _unitOfWork.Message.GetAll(includeProperties: "ApplicationUser");
            return Json(new { data = messageList });
        }
